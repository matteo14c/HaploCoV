...
"--outdir"=>"align",            #Name of the output directory. Defaults to align. 
);
...
sub print_help
{
	...
	print "--outdir <<name>>\tname of a output directory. All alignment files in .snps format are saved there. These are required for assign_HGs_2021.pl .  Defaults to align\n"; 
	print "\n##EXAMPLES:\n\n";
